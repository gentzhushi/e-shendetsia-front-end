...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setError('Dështoi në ngarkimin e profilit. Ju lutem provoni përsëri.');
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Dështoi në ruajtjen e profilit. Ju lutem provoni përsëri.');
      setIsSaving(false);
    }
  };
...
//MOS THARROJM ME JA NDRRU API_URL ME ACTUAL URL TAPI TON NBACK END PROJECTIN!!!